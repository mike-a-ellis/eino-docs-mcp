...
type SearchDocsInput struct {
	...
	// MinScore is the minimum relevance threshold (0-1, default 0.3).
	MinScore float64 `json:"min_score,omitempty" jsonschema:"Minimum relevance score threshold (0-1, default 0.3)"`
}
